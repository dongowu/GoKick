...
import (
	...
	"github.com/dongowu/gokick/internal/cli/gen"
)
...
func Run(args []string) error {
	...
	if err := gen.WriteFile(fmt.Sprintf("internal/repository/%s.go", strings.ToLower(entity)), repoContent); err != nil {
...
func deriveModule(entity string) string {
	// 简单推断：User -> user, OrderItem -> order_item
